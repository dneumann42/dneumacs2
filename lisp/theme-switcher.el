...
(defconst init/theme-state-file
  (expand-file-name "theme-state.el" user-emacs-directory)
  "File containing the theme selected for future sessions.")
...
;; This file contains only a trusted symbol written by this module.
(when (file-readable-p init/theme-state-file)
  (load init/theme-state-file nil 'nomessage))
...
(defun init/theme--save (theme)
  "Persist THEME in `init/theme-state-file'."
  (let ((temporary (make-temp-file "emacs-theme-state-")))
    (unwind-protect
        (progn
          (with-temp-file temporary
            (insert ";;; Generated by theme-switcher.el; do not edit by hand.\n"
                    "(setq init/selected-theme '" (symbol-name theme) ")\n"))
          (rename-file temporary init/theme-state-file t))
